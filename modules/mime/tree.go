...
var (
	...
	text     = newMIME("text/plain", ".txt", magic.Text, svg, xml, lua, perl, python, ruby, json, ndJSON, rtf, srt, tcl, csv, tsv, vCard, iCalendar, warc, vtt, shell, netpbm, netpgm, netppm, netpam)
