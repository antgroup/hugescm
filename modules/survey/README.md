...
[![GoDoc](http://img.shields.io/badge/godoc-reference-5272B4.svg)](https://pkg.go.dev/github.com/Iilun/survey/v2)
...
`any` type and returns an error to show to the user, prompting them for another
...
type Settable interface {
    WriteAnswer(field string, value any) error
}
```
...
func (my *MyValue) WriteAnswer(name string, value any) error {
...
and likely to break your application in these situations. See [#337](https://github.com/Iilun/survey/pull/337#issue-581351617)
...
`github.com/antgroup/hugescm/modules/survey/terminal.InterruptErr` from `Ask` or `AskOne`.
