...
var (
	normalFg = term.AdaptiveColor{Light: lipgloss.Color("235"), Dark: lipgloss.Color("252")}
	fuchsia  = lipgloss.Color("#F780E2")
	green    = term.AdaptiveColor{Light: lipgloss.Color("#02BA84"), Dark: lipgloss.Color("#02BF87")}
)
...
func baseTheme() huh.Theme {
	return huh.ThemeFunc(func(isDark bool) *huh.Styles {
		...
		t.Focused.TextInput.Placeholder = t.Focused.TextInput.Placeholder.Foreground(term.AdaptiveColor{Light: lipgloss.Color("248"), Dark: lipgloss.Color("238")})
