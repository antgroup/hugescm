...
func TestViewport_SelectionOn_WrapOff_SetXOffset(t *testing.T) {
	...
	initialExpectedView := Pad(vp.GetWidth(), vp.GetHeight(), []string{
		"header",
	...
	CmpStr(t, initialExpectedView, vp.View())
...
func TestViewport_SelectionOn_WrapOff_AnsiOnSelection(t *testing.T) {
	...
	vp.SetSelectionEnabled(true)
	setContent(vp, []string{
		"line with " + RedFg.Render("red") + " text",
	})
	expectedView := Pad(vp.GetWidth(), vp.GetHeight(), []string{
		"header",
...
func TestViewport_SelectionOn_WrapOff_AnsiOnSelection_NoOverride(t *testing.T) {
	...
	expectedView := Pad(vp.GetWidth(), vp.GetHeight(), []string{
		"header",
		selectionStyle.Render("line with ") + RedFg.Render("red") + selectionStyle.Render(" text"), // item style preserved
		"",
		"",
		"100% (1/1)",
	})
...
func TestViewport_SelectionOn_WrapOff_SetHighlights(t *testing.T) {
	...
	expectedView := Pad(vp.GetWidth(), vp.GetHeight(), []string{
		"header",
		BlueFg.Render("the ") + GreenFg.Render("first") + BlueFg.Render(" line"),
		"the " + RedFg.Render("second") + " line",
		"the third line",
		"25% (1/4)",
	})
	CmpStr(t, expectedView, vp.View())
...
func TestViewport_SelectionOn_WrapOff_SetHighlightsStyledContent(t *testing.T) {
	...
	vp.SetSelectionEnabled(true)
	setContent(vp, []string{
		RedFg.Render("the first line"),
		GreenFg.Render("the second line"),
		BlueFg.Render("the third line"),
		RedFg.Render("the fourth line"),
	})
	highlights := []Highlight{
		{
			ItemIndex: 0,
	...
	expectedView := Pad(vp.GetWidth(), vp.GetHeight(), []string{
		"header",
		selectionStyle.Render("the ") + GreenFg.Render("first") + selectionStyle.Render(" line"),
		GreenFg.Render("the ") + RedFg.Render("second") + GreenFg.Render(" line"),
		BlueFg.Render("the third line"),
		"25% (1/4)",
	})
	CmpStr(t, expectedView, vp.View())
...
func TestViewport_SelectionOn_WrapOff_SetHighlightsStyledContent_NoOverride(t *testing.T) {
	...
	expectedView := Pad(vp.GetWidth(), vp.GetHeight(), []string{
		"header",
		RedFg.Render("the ") + GreenFg.Render("first") + RedFg.Render(" line"), // item style preserved, highlight applied
		GreenFg.Render("the ") + RedFg.Render("second") + GreenFg.Render(" line"),
		BlueFg.Render("the third line"),
		"25% (1/4)",
	})
...
func TestViewport_SelectionOn_WrapOff_SetHighlightsAnsiUnicode(t *testing.T) {
	...
	expectedView := Pad(vp.GetWidth(), vp.GetHeight(), []string{
		"A💖中é",
		BlueFg.Render("A") + RedFg.Render("💖中") + BlueFg.Render("é line"),
		"another line",
		"",
		"50% (1/2)",
	})
